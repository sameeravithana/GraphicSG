...
${OBJECTDIR}/NodeVisitor.o: NodeVisitor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/NodeVisitor.o NodeVisitor.cpp

${OBJECTDIR}/RenderVisitor.o: RenderVisitor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderVisitor.o RenderVisitor.cpp
...
${OBJECTDIR}/sceneroot.o: sceneroot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sceneroot.o sceneroot.cpp
